 ...
 * Uses modern components by default but can fall back to legacy compatibility versions
 */
export class HeaderModelBridge {
    public originalHeaders: string;
    public summary: Summary | SummaryLegacyCompat;
    ...
    public otherHeaders: Other | OtherLegacyCompat;
    private hasDataInternal: boolean;
    private statusInternal: string;
    private useModernComponents: boolean;
