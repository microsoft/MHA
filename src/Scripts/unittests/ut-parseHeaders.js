...
QUnit.test("parseHeader Tests", function (assert) {
    ...
    var headers = HeaderModel(goodCaseHeaders);
    assert.propEqual(headers.summary.summaryRows, summaryRows, "summaryRows-good-casing");
    assert.propEqual(headers.receivedHeaders.receivedRows, receivedRows, "receivedRows-good-casing");
    assert.propEqual(headers.antiSpamReport.antiSpamRows, antiSpamRows, "antiSpamRows-good-casing");
    assert.propEqual(headers.forefrontAntiSpamReport.forefrontAntiSpamRows, forefrontAntiSpamRows, "forefrontAntiSpamRows-good-casing");
});