...
QUnit.test("GetHeaderList Tests", function (assert) {
    ...
    var headerList = headers.GetHeaderList("Subject: =?UTF-8?B?8J+PiCAgMjAxOSdzIE5vLjEgUmVjcnVpdCwgVGhlIFdvcmxkJ3Mg?=\n" +
    ...
    headerList = headers.GetHeaderList("X-Microsoft-Antispam-Mailbox-Delivery:\n" +
    ...
    headerList = headers.GetHeaderList("Content-Type: multipart/alternative;\n" +
