...
QUnit.test("Received Tests", function (assert) {
    ...
    var header1 = "Received: from BN3NAM04HT205.eop-NAM04.prod.protection.outlook.com\n" +
    ...
    var header2 = "Received: from BN3NAM04FT003.eop-NAM04.prod.protection.outlook.com\n" +
    ...
    var header3 = "Received: from vmta6.response.nfcu.org (199.204.166.217) by\n" +
    ...
    var header4 = "Received: from localhost (10.0.22.21) by vmta6.response.nfcu.org (PowerMTA(TM) v3.5r17) id hrakoo0lrlgv for <sgriffin@outlook.com>; Fri, 20 Apr 2018 17:51:19 -0400 (envelope-from <abuse_281D5450C2D61412E888B78BD84CCB3D2E80DB1641131EAF@response.nfcu.org>)";
    ...
    var github = Received();
    var githubHeader1 = "Received: from CO1NAM03HT217.eop-NAM03.prod.protection.outlook.com\n" +
    ...
    var githubHeader2 = "Received: from CO1NAM03FT028.eop-NAM03.prod.protection.outlook.com\n" +
    ...
    var githubHeader3 = "Received: from o9.sgmail.github.com (167.89.101.2) by\n" +
    ...
    var githubHeader4 = "Received: by filter0652p1las1.sendgrid.net with SMTP id filter0652p1las1-5089-5ADBF958-25\n" +
        "        2018-04-22 02:54:17.028704749 +0000 UTC";
    github.init(githubHeader4);
    var githubHeader5 = "Received: from smtp.github.com (out-3.smtp.github.com [192.30.252.194])\n" +
