...
QUnit.test("RFC 2047 Tests", function (assert) {
    ...
    assert.equal(Decoder.clean2047Encoding("=?UTF-8?B?8J+PiCAgMjAxOSdzIE5vLjEgUmVjcnVpdCwgVGhlIFdvcmxkJ3Mg?=\n" +
        " =?UTF-8?B?VGFsbGVzdCBUZWVuYWdlciwgVG9wIFBsYXlzIG9mIHRoZSBXZWVrICYgbW9y?=\n" +
        " =?UTF-8?B?ZQ==?="), "🏈  2019's No.1 Recruit, The World's Tallest Teenager, Top Plays of the Week & more");
    assert.equal(Decoder.clean2047Encoding("Subject: =?Windows-1252?Q?Fwd:_Scam_Alert_from_a_neighbor_on_NextDoor_-_Don=92t_re?=\n" +
    ...
    assert.equal(Decoder.clean2047Encoding("Subject: =?gb2312?B?RndkOiDT67DCwu3SqdK119y+rcDto6ywosDvsM2wzdfcvOCjrMu5sdi/y9fc?=" +
        " =?gb2312?B?ssOjrNK7xvDR0L6/yc/K0Lmry762rcrCu+HD2Mrp?="), "Subject: Fwd: 与奥马药业总经理，阿里巴巴总监，斯必克总裁，一起研究上市公司董事会秘书");
    assert.equal(Decoder.clean2047Encoding("Subject: =?gb2312?Q?=D3=EB=B0=C2=C2=ED=D2=A9=D2=B5=D7=DC=BE=AD=C0=ED=A3?=" +
        ...
        "=?gb2312?Q?=D0=B9=AB=CB=BE=B6=AD=CA=C2=BB=E1=C3=D8=CA=E9?="), "Subject: 与奥马药业总经理，阿里巴巴总监，斯必克总裁，一起研究上市公司董事会秘书");
...
QUnit.test("Mailsploit Tests", function (assert) {
    ...
    assert.equal(Decoder.clean2047Encoding("=?utf-8?Q?=42=45=47=49=4E=20=2F=20=20=2F=20=00=20=50=41=53=53=45=44=20=4E=55=4C=4C=20=42=59=54=45=20=2F=20=0D=0A=20=50=41=53=53=45=44=20=43=52=4C=46=20=2F=20=45=4E=44?="), "BEGIN /  / \0 PASSED NULL BYTE / \r\n PASSED CRLF / END");
    assert.equal(Decoder.clean2047Encoding("<=?utf-8?Q?=42=45=47=49=4E=20=2F=20=20=2F=20=00=20=50=41=53=53=45=44=20=4E=55=4C=4C=20=42=59=54=45=20=2F=20=0D=0A=20=50=41=53=53=45=44=20=43=52=4C=46=20=2F=20=45=4E=44?=@example.com>"), "<BEGIN /  / \0 PASSED NULL BYTE / \r\n PASSED CRLF / END@example.com>");
    assert.equal(Decoder.clean2047Encoding("=?utf-8?b?c2VydmljZUBwYXlwYWwuY29tPGlmcmFtZSBvbmxvYWQ9YWxlcnQoZG9jdW1lbnQuY29va2llKSBzcmM9aHR0cHM6Ly93d3cuaHVzaG1haWwuY29tIHN0eWxlPSJkaXNwbGF5Om5vbmUi?==?utf-8?Q?=0A=00?=@mailsploit.com"), "service@paypal.com<iframe onload=alert(document.cookie) src=https://www.hushmail.com style=\"display:none\"\n\0@mailsploit.com");
    // Tests from actual Mailsploit mails
    // macOS  ≤ 10.13.1 / iOS ≤ 11  .2 Mail.app / Open-Xchange < 7.1  0.0 / CloudMagic Newton ≤ 9.8.79-like
    assert.equal(Decoder.clean2047Encoding("=?utf-8?b?cG90dXNAd2hpdGVob3VzZS5nb3Y=?==?utf-8?Q?=00?==?utf-8?b?KHBvdHVzQHdoaXRlaG91c2UuZ292KQ==?=@mailsploit.com"), "potus@whitehouse.gov\0(potus@whitehouse.gov)@mailsploit.com");
    // Mozilla-Thunderbird ≤ 52.5.0-like
    assert.equal(Decoder.clean2047Encoding("\"=?utf-8?b?cG90dXNAd2hpdGVob3VzZS5nb3Y=?==?utf-8?Q?=0A=00?=\"\r\n <=?utf-8?b?cG90dXNAd2hpdGVob3VzZS5nb3Y=?==?utf-8?Q?=0A=00?=@mailsploit.com>"), "\"potus@whitehouse.gov\n\0\"\r\n <potus@whitehouse.gov\n\0@mailsploit.com>");
    // Variation #1
    assert.equal(Decoder.clean2047Encoding("=?utf-8?b?cG90dXNAd2hpdGVob3VzZS5nb3Y=?==?utf-8?Q?=00=0A?=@mailsploit.com"), "potus@whitehouse.gov\0\n@mailsploit.com");
    // Variation #2
    assert.equal(Decoder.clean2047Encoding("\"=?utf-8?b?cG90dXNAd2hpdGVob3VzZS5nb3YiIDxwb3R1c0B3aGl0ZWhvdXNlLmdvdj4=?==?utf-8?Q?=00=0A?=\"\r\n <demo@mailsploit.com>"), "\"potus@whitehouse.gov\" <potus@whitehouse.gov>\0\n\"\r\n <demo@mailsploit.com>");
    // Variation #2.1
    assert.equal(Decoder.clean2047Encoding("\"=?utf-8?b?cG90dXNAd2hpdGVob3VzZS5nb3YiIDx0ZXN0Pg==?==?utf-8?Q?=00=0A?=\"\r\n <demo@mailsploit.com>"), "\"potus@whitehouse.gov\" <test>\0\n\"\r\n <demo@mailsploit.com>");
    // Variation #2.2
    assert.equal(Decoder.clean2047Encoding("\"=?utf-8?b?dGVzdCIgPHBvdHVzQHdoaXRlaG91c2UuZ292Pg==?==?utf-8?Q?=00=0A?=\"\r\n <demo@mailsploit.com>"), "\"test\" <potus@whitehouse.gov>\0\n\"\r\n <demo@mailsploit.com>");
    // Variation #3
    assert.equal(Decoder.clean2047Encoding("\"=?utf-8?b?InBvdHVzQHdoaXRlaG91c2UuZ292IiA8cG90dXNAd2hpdGVob3VzZS5nb3Y+?==?utf-8?Q?=0A=00=00=00?=\"\r\n <demo@mailsploit.com>"), "\"\"potus@whitehouse.gov\" <potus@whitehouse.gov>\n\0\0\0\"\r\n <demo@mailsploit.com>");
    // Variation #3.1
    assert.equal(Decoder.clean2047Encoding("\"=?utf-8?b?InRlc3QiIDxwb3R1c0B3aGl0ZWhvdXNlLmdvdj4=?==?utf-8?Q?=0A=00=00=00?=\"\r\n <demo@mailsploit.com>"), "\"\"test\" <potus@whitehouse.gov>\n\0\0\0\"\r\n <demo@mailsploit.com>");
    // Variation #3.2
    assert.equal(Decoder.clean2047Encoding("\"=?utf-8?b?InBvdHVzQHdoaXRlaG91c2UuZ292IiA8dGVzdD4=?==?utf-8?Q?=0A=00=00=00?=\"\r\n<demo@mailsploit.com>"), "\"\"potus@whitehouse.gov\" <test>\n\0\0\0\"\r\n<demo@mailsploit.com>");
    // Variation #4
    assert.equal(Decoder.clean2047Encoding("=?utf-8?b?cG90dXNAd2hpdGVob3VzZS5nb3Y=?==?utf-8?Q?=0A=00?=@mailsploit.com"), "potus@whitehouse.gov\n\0@mailsploit.com");
    // Variation #5
    assert.equal(Decoder.clean2047Encoding("\" =?utf - 8 ? b ? cG90dXNAd2hpdGVob3VzZS5nb3Y =?=\" <demo@mailsploit.com>"), "\" =?utf - 8 ? b ? cG90dXNAd2hpdGVob3VzZS5nb3Y =?=\" <demo@mailsploit.com>");
    // Variation #6
    assert.equal(Decoder.clean2047Encoding("=?utf-8?b?cG90dXNAd2hpdGVob3VzZS5nb3YocG90dXNAd2hpdGVob3VzZS5nb3Y=?==?utf-8?Q?=00?=@mailsploit.com"), "potus@whitehouse.gov(potus@whitehouse.gov\0@mailsploit.com");
    // Generic test #1
    assert.equal(Decoder.clean2047Encoding("\"=?utf-8?Q?=42=45=47=49=4E=20=2F=20=28=7C=29=7C=3C=7C=3E=7C=40=7C=2C=7C=3B=7C=3A=7C=5C=7C=22=7C=2F=7C=5B=7C=5D=7C=3F=7C=2E=7C=3D=20=2F=20=00=20=50=41=53=53=45=44=20=4E=55=4C=4C=20=42=59=54=45=20=2F=20=0D=0A=20=50=41=53=53=45=44=20=43=52=4C=46=20=2F=20?==?utf-8?b?RU5E=?=\"\r\n <demo@mailsploit.com>"), "\"BEGIN / (|)|<|>|@|,|;|:|\\|\"|/|[|]|?|.|= / \0 PASSED NULL BYTE / \r\n PASSED CRLF / END\0\"\r\n <demo@mailsploit.com>");
    // Generic test #2
    assert.equal(Decoder.clean2047Encoding("=?utf-8?Q?=42=45=47=49=4E=20=2F=20=28=7C=29=7C=3C=7C=3E=7C=40=7C=2C=7C=3B=7C=3A=7C=5C=7C=22=7C=2F=7C=5B=7C=5D=7C=3F=7C=2E=7C=3D=20=2F=20=00=20=50=41=53=53=45=44=20=4E=55=4C=4C=20=42=59=54=45=20=2F=20=0D=0A=20=50=41=53=53=45=44=20=43=52=4C=46=20=2F=20?==?utf-8?b?RU5E=?=@mailsploit.com"), "BEGIN / (|)|<|>|@|,|;|:|\\|\"|/|[|]|?|.|= / \0 PASSED NULL BYTE / \r\n PASSED CRLF / END\0@mailsploit.com");
});
...
QUnit.test("2047 Junkmail Tests", function (assert) {
    ...
    assert.equal(Decoder.clean2047Encoding("=?UTF-8?Q?=F0=9D=93=A2=F0=9D=93=BB=F0=9D=93=B2=20=E2=84=92=F0=9D=93=AA=F0=9D=93=B7=F0=9D=93=B4=F0=9D=93=AA=F0=9D=93=B7=20?= =?UTF-8?Q?=F0=9D=93=B5=20=F0=9D=93=A3=F0=9D=93=BB=F0=9D=93=B2=F0=9D=93=AC=F0=9D=93=B4=20=E2=84=9B=F0=9D=92=86=F0=9D=93=BF=F0=9D=92=86?= =?UTF-8?Q?=F0=9D=93=B2=F0=9D=93=AA=F0=9D=93=AB=F0=9D=92=86=F0=9D=93=BD=F0=9D=92=86=F0=9D=93=BC=20=F0=9D=93=B2=F0=9D=93=B7=20?= =?UTF-8?Q?=F0=9D=93=BC?= "), "𝓢𝓻𝓲 ℒ𝓪𝓷𝓴𝓪𝓷 𝓵 𝓣𝓻𝓲𝓬𝓴 ℛ𝒆𝓿𝒆𝓲𝓪𝓫𝒆𝓽𝒆𝓼 𝓲𝓷 𝓼 ");
