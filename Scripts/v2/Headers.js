...
function initViewModels() {
    debugOut('initViewModels');
    viewModel = new HeaderModel();
    debugOut('rebuildSections');
    rebuildSections();
}
...
var HeaderModel = function () {
    ...
    debugOut('Created Summary');
    this.receivedHeaders = new Received();
    debugOut('Created Received');
    this.forefrontAntiSpamReport = new ForefrontAntiSpamReport();
    debugOut('Created ForefrontAntiSpamReport');
    this.antiSpamReport = new AntiSpamReport();
    debugOut('Created AntiSpamReport');
    this.otherHeaders = new Other();
    debugOut('Created Other');

    debugOut('Created sub objects');
