            ...
            for (i = 0; i < viewModel.forefrontAntiSpamReport.forefrontAntiSpamRows.length; i++) {
                if (viewModel.forefrontAntiSpamReport.forefrontAntiSpamRows[i].get()) {
                    ...
                    $("<td/>")
                        ...
                        .appendTo(row);
                    linkVal = mhaStrings.mapHeaderToURL(viewModel.forefrontAntiSpamReport.forefrontAntiSpamRows[i].url, viewModel.forefrontAntiSpamReport.forefrontAntiSpamRows[i].get());
                    $("<td/>")
                        .html(linkVal)
                        .appendTo(row);
                }
            ...
            for (i = 0; i < viewModel.antiSpamReport.antiSpamRows.length; i++) {
                if (viewModel.antiSpamReport.antiSpamRows[i].get()) {
                    ...
                    $("<td/>")
                        ...
                        .appendTo(row);
                    linkVal = mhaStrings.mapHeaderToURL(viewModel.antiSpamReport.antiSpamRows[i].url, viewModel.antiSpamReport.antiSpamRows[i].get());
                    $("<td/>")
                        .html(linkVal)
                        .appendTo(row);
                }
